...
with open("params_nd_{}.pkl".format(l_name), "wb") as fp:
  pickle.dump(params_nd, fp)

with open("opt_state_nd_{}.pkl".format(l_name), "wb") as fp:
  pickle.dump(opt_state_nd, fp)

with open("sample_nd_{}.pkl".format(l_name), "wb") as fp:
  pickle.dump(sample_nd, fp)

with open("loss_{}.pkl".format(l_name), "wb") as fp:
  pickle.dump(jnp.asarray(batch_loss), fp)