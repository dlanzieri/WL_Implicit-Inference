...
In the first step, we introduce a parametric function $f_{\varphi}$ such that:
     ...
     \end{equation}
which aims to reduce the dimensionality of the data while preserving information. Typically, the compressed statistics $\bm{y}$ is assumed to have the same dimension of $\bm{\theta}$. \\
